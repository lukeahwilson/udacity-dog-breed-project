...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        ...
        # prints calculated statistics ## NOTE: variable name discrepencies generate error, this section commented out per mentor due to different labelling of the dictionary
